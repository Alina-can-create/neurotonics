...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#0a0a1a]/95 backdrop-blur-md border-b border-purple-900/30">
          ...
          <div className="md:hidden py-4 border-t border-purple-900/30">
            {siteContent.navigation.map((item) => (
              <Link
                ...
                className="block py-3 text-gray-300 hover:text-purple-400 transition-colors text-sm font-medium"
              >
                {item.label}
              </Link>
            ))}
